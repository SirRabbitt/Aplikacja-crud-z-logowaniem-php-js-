...
$stmt = $pdo->prepare("SELECT Education.year, Institution.institution_id, Institution.name FROM Education JOIN Institution ON Education.institution_id = Institution.institution_id WHERE Education.profile_id = :pid");
$stmt->execute(array(":pid" => $_GET['profile_id']));
...
<?php foreach ($educations as $education) : ?>
    <li><?php echo htmlentities($education['year']); ?>: <?php echo htmlentities($education['Institution.name']); ?></li>
<?php endforeach; ?>
</ul>
</body>
</html>
