...
$stmt = $pdo->prepare("SELECT Education.year, Institution.institution_id, Institution. FROM Education JOIN Institution ON Education.institution_id = Institution.institution_id WHERE Education.profile_id = :pid");
$stmt->execute(array(":pid" => $_GET['profile_id']));
