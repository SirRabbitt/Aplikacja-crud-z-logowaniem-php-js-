...
<p>Edukacja:
    <select name="edu_school">
        ...
        while ($institution = $stmt->fetch(PDO::FETCH_ASSOC)) {
            echo '<option value="' . $institution['institution_id'] . '">' . htmlentities($institution['name']) . '</option>';
        }
        ?>
    </select>
    Rok: <input type="text" name="edu_year">
</p>
