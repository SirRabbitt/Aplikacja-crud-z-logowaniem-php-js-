...
if (isset($_POST['edu_school']) && isset($_POST['edu_year']) && ($_POST['edu_school'] != $initial_education['name'] || $_POST['edu_year'] != $initial_education['year'])) {
    ...
    if ($row === false) {
        $_SESSION['error'] = "Wybrana uczelnia nie istnieje w bazie danych";
        header("Location: edit.php?profile_id=".$_POST['profile_id']);
        return;
    }
...
<script>
        $(document).ready(function() {
            ...
            // Dodaj funkcję, aby formularz został przesłany po zmianie wartości pola "Imię"
