...
<div id="edu_fields">
  <div id="edu1">
    <p>School: <input type="text" size="80" name="edu_school1" class="school"></p>
    <p>Year: <input type="text" name="edu_year1"></p>
  </div>
</div>
<input type="button" value="+" onclick="eduCount++; $('#edu_fields').append('<div id=\'edu' + eduCount + '\'> <p>School: <input type=\'text\' size=\'80\' name=\'edu_school' + eduCount + '\' class=\'school\'></p> <p>Year: <input type=\'text\' name=\'edu_year' + eduCount + '\'></p> </div>');">
