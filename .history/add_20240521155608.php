...
if (isset($_GET['term'])) {
    ...
    // Pobierz listę szkół pasujących do wpisanego terminu
    $stmt = $pdo->prepare('SELECT name FROM Institution WHERE name LIKE :term LIMIT 10');
    ...
    <script>
        $(document).ready(function() {
            $('#edu_school').autocomplete({
                source: <?php echo json_encode($schoolNames); ?>,
                minLength: 2
            });
        });
    </script>
